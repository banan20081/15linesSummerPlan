 ...
 *	<Describe the game here> MasterMind.java is a game in which the player
 * 	is trying to guess a hidden String(colors) made by a master (computer).
 * 	The player has 10 tries of guessing the key or else, after the 10 try 
 *	the master code will originally show.
 *	@author Banan Badran
