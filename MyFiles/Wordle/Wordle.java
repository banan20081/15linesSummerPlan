...
// goal word is from the words5


/**
 *	Wordle.java - is a game that acts just like the original game Wordle, 
 * 	in which you have to guess a word that consist of 5 letters/
 * 	YOU CAN CHEAT - you can input the word that you want to guess, or show
 * 	the word that the conputer generated.
 * 	you have 6 chances to try to guess the word, if letter matched the exact
 * 	spot it will turn green, while if it exists in the hidden yword it going
 * 	to turn yellow, but if it doesn't exits it's going to turn grey.
 * 
 *	Provide a description here.
 *
 *	@author	Scott DeRuiter and David Greenstein and Banan Badran
 *	@version	1.0
...
{ 
	...
	public void checkIfWonOrLost ( )
	{
		...
		// else if all guesses are filled then declare loser															HERE!!
